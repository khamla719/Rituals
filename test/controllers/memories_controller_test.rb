...
class MemoriesControllerTest < ActionController::TestCase
  ...
  test "should create memory" do
    assert_difference('Memory.count') do
      post :create, memory: { description: @memory.description, story: @memory.story, title: @memory.title, url: @memory.url }
    end
  ...
  test "should update memory" do
    patch :update, id: @memory, memory: { description: @memory.description, story: @memory.story, title: @memory.title, url: @memory.url }
    assert_redirected_to memory_path(assigns(:memory))
  end
